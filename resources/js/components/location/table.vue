...
<div class="box-table">
    ...
    ></vuetable-pagination>
    <edit-form :product="product" :url="editUrl" id="location-edit" v-if="product" @reload="$refs.vuetable.reload()"></edit-form>
</div>
</template>
    ...
    data () {
        return {
            ...
            fields: [
                ...
                {name: 'gln', title: 'Location Code', sortField: 'gln'},
                {name: 'name', title: 'Location Name', sortField: 'name'},
                {name: 'action', title: ''},
            ],
            params: {},
            product: null,
    ...
    methods: {
        ...
        remove(row) {
            this.$swal({
                ...
                if(r.isConfirmed) {
                    axios.delete(`/location/${row.id}`).then(res => {
                        this.$refs.vuetable.reload()
                    })
                }
            })
