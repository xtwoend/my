            ...
            axios.get(this.url).then(res => {
                printJS({
                    ...
                    properties: [
                        ...
                        { field: 'varian_pack', displayName: 'PACKING VARIAN', columnSize: 200},
                        { field: 'qty', displayName: 'QTY', columnSize: 100},
                        { field: 'pallet_qty', displayName: 'PALLET', columnSize: 100},
                        { field: 'total', displayName: 'ACCEPTED', columnSize: 100},
                        { field: 'return_qty', displayName: 'REJECTED', columnSize: 100},
                    ],
